...
//import 'C:/Users/Daniel/Documents/Tesis/flutter/.pub-cache/hosted/pub.dartlang.org/image_picker-0.4.12+1/lib/image_picker.dart';
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('ObjectDetectionMalaria'),
          ),
          body: TabBarView(
            children: [
              _buildGridView(),
         ...
         children: [
           ...
           Container(
             ...
             child: Row(
               ...
               children: <Widget>[
                 Text(
                   "Objetos: ${widget.data['recognitions']['id'].length}",
                    style: TextStyle(
